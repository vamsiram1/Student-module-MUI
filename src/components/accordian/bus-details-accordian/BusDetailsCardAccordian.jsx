...
import styles from "./BusDetailsCardAccordian.module.css";

import accordianHeader from "../../../assets/transport-overview-icons/accordian_header.svg";
import BusDetailsCard from "../bus-details-card/BusDetailsCard";
// Controlled by parent: receives `expanded` and `onChange`
const BusDetailsCardAccordian = ({ expanded, onChange }) => {
  return (
    <Accordion
      expanded={expanded}
      onChange={onChange}
    ...
    >
      ...
      <AccordionDetails  id="bus-content">
        <Typography component="div">
          <BusDetailsCard /> {/*bus details card */}
        </Typography>
      </AccordionDetails>
    </Accordion>
  );
...
export default BusDetailsCardAccordian;
